...
public class MusicInfos {
	...
	public MusicInfos(String title, String albumName, String[] featurings, String albumImageUrl, Integer duration,
					  Integer totalVoteNumber, Integer positiveVoteNumber, Long size, Long playedPart){

		this.title = title;
		this.albumName = albumName;
		this.authors = albumName;
		if(!(featurings == null || featurings.length == 0)) {
			for(String otherArtist : featurings) {
				this.authors = authors.concat(", ").concat(otherArtist);
			}
		}
